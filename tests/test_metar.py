...
from aero_pi_cam.weather.metar import fetch_metar, format_metar_overlay
...
def test_get_raw_metar_empty() -> None:
    ...
    from aero_pi_cam.weather.metar import get_raw_metar
...
def test_get_raw_taf_empty() -> None:
    ...
    from aero_pi_cam.weather.metar import get_raw_taf
...
def test_format_metar_overlay_no_time_match() -> None:
    ...
    from aero_pi_cam.weather.metar import format_metar_overlay
